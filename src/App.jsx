...
function LoginPage({onLogin}) {
  ...
  const handleLogin = () => {
    ...
    setLoading(true)
    setTimeout(() => {
      if (senha.trim() === '251416') {
        sessionStorage.setItem('rota606_auth', '1')
        onLogin()
      } else {
        setErro('Senha incorreta. Tenta novamente.')
        setLoading(false)
      }
    }, 600)
  }
    ...
    <div style={{
      ...
      <div style={{width:'100%', maxWidth:'360px'}}>
        ...
        <div style={{textAlign:'center', marginBottom:'32px'}}>
          <img src={LOGO_VDLE} alt="VDLE" style={{width:'80px', height:'80px', objectFit:'contain', marginBottom:'14px'}}/>
          <div style={{fontWeight:800, fontSize:'22px', color:'#10D9A0', letterSpacing:'2px'}}>ROTA 606</div>
          <div style={{color:'#8B949E', fontSize:'13px', marginTop:'4px', letterSpacing:'0.5px'}}>VDLE</div>
        </div>

        {/* Card login */}
        <div style={{background:'#161B22', border:'1px solid #21262D', borderRadius:'14px', padding:'28px'}}>
          <div style={{fontWeight:600, fontSize:'17px', color:'#E6EDF3', marginBottom:'6px', textAlign:'center'}}>Bem-vindo 👋</div>
          <div style={{color:'#8B949E', fontSize:'13px', marginBottom:'24px', textAlign:'center'}}>Entra com a tua senha</div>
          ...
          <div style={{marginBottom:'16px'}}>
            ...
            <div style={{
              ...
              color:'#8B949E', padding:'12px 14px', fontSize:'14px',
              display:'flex', alignItems:'center', gap:'8px'
            }}>
              <span style={{color:'#10D9A0'}}>🔒</span>
              <span>Rota 606</span>
            </div>
          </div>
            ...
            <div style={{position:'relative'}}>
              <input
                ...
                style={{
                  ...
                  borderRadius:'8px', color:'#E6EDF3', padding:'12px 44px 12px 14px',
          ...
          <button
            ...
            style={{
              width:'100%', background: (!loading && senha) ? '#10D9A0' : '#21262D',
              color: (!loading && senha) ? '#0D1117' : '#8B949E',
              border:'none', borderRadius:'8px', padding:'13px',
              fontWeight:700, fontSize:'15px', cursor: (!loading && senha) ? 'pointer' : 'not-allowed',
        ...
        <div style={{textAlign:'center', marginTop:'20px', color:'#30363D', fontSize:'11px'}}>
          Rota 606 Dashboard · By Leonardo Silva
        </div>
      </div>
    </div>
  )
